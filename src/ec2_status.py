...
# print("AWS_ACCESS_KEY_ID is: "+ os.environ['AWS_ACCESS_KEY_ID'])
# print("AWS_SECRET_ACCESS_KEY is: "+ os.environ['AWS_SECRET_ACCESS_KEY'])
# print("AWS_SESSION_TOKEN is: "+ os.environ['AWS_SESSION_TOKEN'])
# or
